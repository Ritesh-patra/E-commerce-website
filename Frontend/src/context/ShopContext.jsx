...
const ShopContextProvider = (props) => {
  ...
  const removeItem = async (id, size) => {
    const _currentCart = Array.isArray(cartItems) ? cartItems : [];
    setCartItems(_currentCart.filter((item) => item._id !== id));
    try {
  ...
  const updateCart = async (cartItemId, size, action) => {
    ...
    let updatedCart = _currentCart.map((item) => {
  ...
  const _cartItemsArray = Array.isArray(cartItems) ? cartItems : [];
  const totalPrice = _cartItemsArray.reduce(
